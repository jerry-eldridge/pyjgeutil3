...
class Cat2:
    ...
    # identity object
    def zero(self):
        return Cat2(self.c,self.e)
    # functor variable object
    def one(self):
        return Cat2(self.c,self.v)
    # eta : e -> c
    def eta(self):
        if self.objs() >= 1:
            try:
