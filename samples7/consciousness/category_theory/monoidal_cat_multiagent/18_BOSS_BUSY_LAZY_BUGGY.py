...
def run(m,n,tag):
    ...
    if F(b2) == b and tag2 == tag:
        ...
        P[b].inbox = [[b2,tag2,message2]] + P[b].inbox 
        return False
...
def recv(n,m,tag):
    ...
    if len(P[a].inbox) > 0:
        a2,tag2,message2 = P[a].inbox.pop(0)
    else:
        return False
    if F(a2) == a and tag2 == tag:
        word2,cmd2 = message2
        P[a].program.append(cmd2)
        P[a].word = word2
        return True
    else:
        P[a].inbox = [[a2,tag2,message2]] + P[b].inbox 
        return False
    return flag
