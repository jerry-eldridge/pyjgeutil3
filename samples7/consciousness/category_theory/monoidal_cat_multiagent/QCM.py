...
def run_program(word, prog):
    ...
    for line in lines:
        ...
        if cmd == 'ai':
            ...
            ####################################
            # [1] Microsoft Copilot, a large language
            # model.
            #
            # Simulate a measurement morphism
            # by projecting or tagging a component.
            # For now, we just return the structure
            # with a 'measured' tag.
            #
            def measure(w):
                return Cat1([Cat1('measure'), w])
            w2 = measure(w)
            #
            ####################################
...
#
# [2] Microsoft Copilot, a large language model
# (refers to 'categorical quantum mechanics' (CQM)
# using my symmetric monoidal category.)
# [2] writes "Abramsky & Coecke (2004)" called
# "A Categorical Semantics of Quantum Protocols"
# relating to "dagger compact closed categories"
# where "morphisms represent quantum processes"
# with "teleportation, entanglement, and measurement
# are all modeled categorically".
# TODO: Fact check these reference papers.
# and [1] writes "Bob Coecke & Aleks Kissinger (2017)"
# with textbook "Picturing Quantum Processes"
# with a visual introduction to CQM. It uses
# "string diagrams" to represent morphisms, tensor
# products, and duals. Also [1] writes "Selinger (2007)"
# with title "Dagger Compact Closed Categories
# and Completely Positive Maps".
# [4] https://arxiv.org/abs/quant-ph/0402130
# "A categorical semantics of quantum protocols",
# Samson Abramsky, Bob Coecke
#
def bell_state(a,b):
    # Bell state: entangled pair from identity
    return a * b  # e0 -> a*b

def teleportation_protocol():
    # Initial setup: qubit a to teleport,
    # entangled pair b*c
    a = Cat1('a') # signal
    b = Cat1('b')
    c = Cat1('c')
    
    # Step 1: Combine a with entangled pair
    signal = a
    w = signal * bell_state(b,c)  # a  DP  (b  DP  c)
