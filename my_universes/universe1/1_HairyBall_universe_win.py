import sys
sys.path.append(r"C:/Users/jerry/Desktop/_Art/my_universes")
import universes
import universes.scene_object as so
import universes.shapes.primitives as ps

BIGDATA = r"C:/Users/jerry/Desktop/_Art/my_universes/universe1/my_scenes/"
...
G = ps.create_hairy_ball(nfibers=15)
fmat = "HairyBallScene03.mtl"
nmat = "CubeMat"
Sce.add(G,"HairyBall",fmat,nmat)
...
G = ps.create_cube()
Sce.add(G,"camera1_shape",fmat,nmat)
...
G = ps.create_cube()
Sce.add(G,"Cube_Of_Enlightment",fmat,nmat)
...
G = ps.create_cube()
Sce.add(G,"RoomCeilingLight",fmat,nmat)
...
Sce.add(G,"CylinderBody",fmat,nmat)
