from ..shapes.common import vectors as v
from ..shapes.common import QuaternionGroup as HH
...
class RobotArm:
    ...
    def Transforms(S):
        ...
        for i in range(n-1,-1,-1):
            ...
            T2 = v.rotation_matrix(S.Theta[i],0,0,1)
            Ti = Mul(T2,T1)
            T.append(Ti)
