from .canvas2d import line_intersection as li
from .shapes.common import graph
from .shapes.common import affine as aff
...
def Collide(G1, G2):
    L = []
    for e in G1['E']:
        A,B = [G1['pts'][v] for v in e]
        for f in G2['E']:
            C,D = [G2['pts'][v] for v in f]
