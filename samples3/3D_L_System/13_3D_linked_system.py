...
s14 = lsm.PathSystem(s_sys1,
            [(0,1,0),(2,0,0),(0,0,-1)])
line2 = gsm.String_to_line2(s14,gsm.line,gsm.point,
                flag=False,n=2)

G,Gs = gsm.Shape0(start5,rules5, line2, gsm.point,
              flag=True, n=2)
print("|pts(G)| = ",len(G['V']))
    
# Save Scene 1
ext.Graphs2OBJ(BIGDATA+"3D_L_system_6.obj",Gs,"scene")

# Double-Click on OBJ file
import os
os.system(BIGDATA+"3D_L_system_6.obj")
