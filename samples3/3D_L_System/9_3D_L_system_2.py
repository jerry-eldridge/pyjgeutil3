...
def draw(G,Gs,s, line, point):
    ...
    for i in range(len(s)):
        ...
        if c in ["c"]:
            ...
            axis1 = [0,0,1]
            qi = aff.HH.rotation_quaternion(angle,
...
G['pts'] = []
Gs = []
H0,_ = Shape0(start,rules, line,point)
...
# Save Scene 1
ext.Graphs2OBJ(BIGDATA+"3D_L_system_4_2.obj",Gs,"scene")

# Double-Click on OBJ file
import os
os.system(BIGDATA+"3D_L_system_4_2.obj")
